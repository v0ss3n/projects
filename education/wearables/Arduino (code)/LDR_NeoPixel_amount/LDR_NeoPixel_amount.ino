/*
  ...
  Connect the red wire of the neopixel strip to +3.3V
...
// NeoPixel Setup
const int numPixels = 10;   // Number of NeoPixels on the strip. Change according to the amount of NeoPixels
...
void loop() {
  ...
  int mappedLdr = map(ldrValue, 65, 100, 0, 100);  // Map to percentage (0-100)
